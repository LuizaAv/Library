...
function App() {
  ...
  useEffect(() => {
    //fetching books data from db and store it in result variable
  ...
  //callback function, which update the loggin state recieving the state from login component and set it in local storage
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route
          path="/login"
          element={<Login onUpdate={updateLoggedInValue} />}
        />
        <Route path="/login/register" element={<Register />} />
        <Route
          path="/library/bookdetails/:id"
          element={<Bookdetails data={result} />}
        />
        <Route
          path="/login/userhomepage/:id"
          element={<UserHomePage booksData={result} />}
        />
      </Routes>
