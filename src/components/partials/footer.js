        ...
        <div className="footerMainContainer">
            <div className="footerSecondContainer">
                ...
                <div id = "helpfulLinks" className="footerDiv">
                    <h3>Helpful links</h3>
                    <a href = "https://picsartacademy.am/" target="_blank">Academy website</a>
                    <a href = "https://www.linkedin.com/company/picsart-academy/">LinkedIn page</a>
                    <a href = "https://www.instagram.com/picsart__academy/" target="_blank">Instagram page</a>
                </div>
            </div>
        </div>
    )
